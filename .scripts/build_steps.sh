...
# automatically.
/usr/bin/sudo -n yum install -y mesa-libGL mesa-libEGL mesa-libGL-devel mesa-libEGL-devel mesa-dri-drivers mesa-libGLU-devel libglvnd-egl libglvnd-glx libglvnd-opengl
)
